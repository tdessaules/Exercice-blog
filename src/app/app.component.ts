...
export class AppComponent {
  ...
  // utilisation d'un tableau de Post
  ...
  ngOnInit(){
	 ...
	 // informations du poste 1, la date est calculée automatiquement dans le constructeur
	 ...
	 // informations du poste 2, la date est calculée automatiquement dans le constructeur
	 ...
	 // informations du poste 3, la date est calculée automatiquement dans le constructeur
